...
class BinaryStore:
    ...
    def start_holdout_access(self, training_run_id: str, final_run_id: str, selection_hash: str) -> dict[str, object]:
        with self.catalog.transaction() as connection:
            ...
            if existing is not None:
                if existing["selection_hash"] != selection_hash:
                    raise SchemaError({"reason": "holdout_selection_changed", "training_run_id": training_run_id})
